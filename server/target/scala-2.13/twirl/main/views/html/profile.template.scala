...
"""),_display_(/*3.2*/main("Profile")/*3.17*/ {_display_(Seq[Any](format.raw/*3.19*/("""
    """),format.raw/*4.5*/("""<h4>Profile page</h4>
""")))}))
      }
    }
  }
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: server/app/views/profile.scala.html
                  HASH: 4e4c40bea693e50d004ffdeb4c3ac70cd3a52cda
                  MATRIX: 724->1|820->4|847->6|870->21|909->23|940->28
